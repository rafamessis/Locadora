 ...
 * @author Hudson
 */
public class Distribuidoraview extends javax.swing.JInternalFrame {
    ...
    public void preencheTabela(){
        ...
        for(int i=0;i<distribuidoras.size();i++){
            tabela.addRow(new Object[]{distribuidoras.get(i).getCodigo(),distribuidoras.get(i).getNome()});
        }
    ...
    private void tabelaDistribuidoraMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaDistribuidoraMouseClicked
        ...
        Distribuidora distribuidora = distribuidoras.get(tabelaDistribuidora.getSelectedRow());
           
        campoCodigo.setText(String.valueOf(distribuidora.getCodigo()));
        campoDescricao.setText(distribuidora.getNome());
        
        codigoAtual = distribuidora.getCodigo();
    ...
    private void botaoExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoExcluirActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this,objetoRemoto.removerDistribuidora(codigoAtual));
            campoCodigo.setEnabled(false);
            campoDescricao.setEnabled(false);
            campoCodigo.setText("");
            campoDescricao.setText("");
    ...
    private void botaoSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoSalvarActionPerformed
        ...
        if (!(campoDescricao.getText()).isEmpty()){
            ...
            distribuidora.setNome(campoDescricao.getText());

            try {
                Registry conexao = LocateRegistry.getRegistry("127.0.0.1",1500);
                Interface objetoRemoto = (Interface) conexao.lookup("chave");
                if(codigoAtual > 0){
                    JOptionPane.showMessageDialog(this,objetoRemoto.atualizaDistribuidora(distribuidora,codigoAtual));
                }else{
                    JOptionPane.showMessageDialog(this,objetoRemoto.inserirDistribuidora(distribuidora));
                }
                campoCodigo.setEnabled(false);
                campoDescricao.setEnabled(false);
                campoCodigo.setText("");
    ...
    private void botaoNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoNovoActionPerformed
        ...
        botaoExcluir.setEnabled(false);
        botaoCancelar.setEnabled(true);
        tabelaDistribuidora.setVisible(false);
